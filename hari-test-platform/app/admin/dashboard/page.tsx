...
export default function DashboardPage() {
  ...
  if (!data) {
    return <div className="p-8 text-muted-foreground">Couldn't load the dashboard.</div>;
  }
              ...
              data.liveTests.map((t) => (
                ...
                >
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">{t.testCode}</p>
                  </div>
            ...
            {data.recentTests.length === 0 ? (
              ...
              data.recentTests.map((t) => (
                ...
                >
                  ...
                  <Badge className={STATUS_BADGE_CLASS[t.derivedStatus]}>{t.derivedStatus}</Badge>
                </Link>
              ))
            )}
          </CardContent>
            ...
            data.recentResults.map((r) => (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">{r.testTitle}</p>
                </div>
