    ...
    <div className="mx-auto max-w-6xl space-y-6 p-4 sm:p-8">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="min-w-0">
          ...
          <h1 className="mt-2 truncate text-2xl font-semibold">{testTitle} — Results</h1>
        </div>
          ...
          {attempts.length === 0 ? (
            ...
            <Table>
              ...
              <TableBody>
                {attempts.map((a) => (
                  <TableRow key={a.id}>
                    <TableCell className="max-w-[160px] truncate">{a.studentName || "—"}</TableCell>
                    <TableCell className="max-w-[200px] truncate">{a.studentEmail}</TableCell>
